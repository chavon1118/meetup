...
public class Section implements Comparable<Section> {
    ...
    public String getCourseInfo() {
        String courseinfo = "Course: " + this.getCourse().getCode() + this.getCourse().getNumber()
                + " Section: " + this.getName() + " Course Time: " + this.getCourseTimeInfo();
        return courseinfo;
    }

    public String getCourseTimeInfo() {
        return this.getCourseTime().getStartTime() + " - " + this.getCourseTime().getEndTime();
    }
}
